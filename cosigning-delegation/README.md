...
git clone \
  ...
  --single-branch \
  --depth 1 \
  --branch cosigning-delegations \
  cosigning-delegations
```
...
Illustrates the use of delegation contracts to create multi-signatory contracts.
